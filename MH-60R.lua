BIOS.protocol.beginModule("MH-60R", 0xA400)
BIOS.protocol.setExportModuleAircrafts({"MH-60R", "UH-60L"})
--by Tanuki44
local documentation = moduleBeingDefined.documentation

local document = BIOS.util.document

local defineFloat = BIOS.util.defineFloat								--Instrument Value
local defineIndicatorLight = BIOS.util.defineIndicatorLight				--Indicator State
local definePushButton = BIOS.util.definePushButton						--default_button
local definePotentiometer = BIOS.util.definePotentiometer				--default_axis_limited
local defineTumb = BIOS.util.defineTumb									--default_2_position_tumb
...
local defineToggleSwitch = BIOS.util.defineToggleSwitch					--default_toggle_tumb
--local defineToggleSwitchToogleOnly = BIOS.util.defineToggleSwitchToggleOnly
...
local defineMultipositionSwitch = BIOS.util.defineMultipositionSwitch	--multiposition_switch_limited
local defineRotary = BIOS.util.defineRotary								--default_axis
--local defineRotaryPlus = BIOS.util.defineRotaryPlus					--default_axis with command1 command2

--local define3PosTumb = BIOS.util.define3PosTumb							--default_3_position_tumb
----BIOS.util.defineTumb(msg, device_id, command, arg_number, 1, {-1, 1}, nil, false, category, description)

local defineIntegerFromGetter = BIOS.util.defineIntegerFromGetter

--Lighting Switches
defineFloat("LGHT_SW", 206, {0.0, 1.0}, "Lights", "Lighting_Switches")

--Caution Lights
defineIndicatorLight("CIS_PLT_HDG",			212, "CISP", "LIGHT_HDG_ON")
defineIndicatorLight("CIS_PLT_NAV",			213, "CISP", "LIGHT_NAV_ON")
defineIndicatorLight("CIS_PLT_ALT",			214, "CISP", "LIGHT_ALT_ON")
defineIndicatorLight("CIS_PLT_DPLR",		215, "CISP", "LIGHT_DPLRGPS")
defineIndicatorLight("CIS_PLT_VOR",			216, "CISP", "LIGHT_VOR_LGT")
defineIndicatorLight("CIS_PLT_ILS",			217, "CISP", "LIGHT_ILS_LGT")
defineIndicatorLight("CIS_PLT_BCKCRS",		218, "CISP", "LIGHT_BACKCRS")
defineIndicatorLight("CIS_PLT_FMHME",		219, "CISP", "LIGHT_FMHOME")
defineIndicatorLight("CIS_PLT_TRNRM",		220, "CISP", "LIGHT_TRNORM")
defineIndicatorLight("CIS_PLT_TRALT",		221, "CISP", "LIGHT_TRALT")
defineIndicatorLight("CIS_PLT_CRSHDGPLT",	222, "CISP", "LIGHT_HDGPLT")
defineIndicatorLight("CIS_PLT_CRSHDGCPLT",	223, "CISP", "LIGHT_HDGCPLT")
defineIndicatorLight("CIS_PLT_GYRNRM",		224, "CISP", "LIGHT_GYRONORM")
defineIndicatorLight("CIS_PLT_GYROALT", 	225, "CISP", "LIGHT_GYROALT")
defineIndicatorLight("CIS_PLT_BRG2ADF", 	226, "CISP", "LIGHT_BRG2ADF")
defineIndicatorLight("CIS_PLT_BRG2VOR", 	227, "CISP", "LIGHT_BRG2VOR")

-- AFCS LIGHTS
defineIndicatorLight("AFC_BST_LGHT",	241, "AFCS", "LIGHT_AFCS_BOOST")
defineIndicatorLight("AFC_SS1_LGHT",	242, "AFCS", "LIGHT_AFCS_SAS1")
defineIndicatorLight("AFC_SS2_LGHT",	243, "AFCS", "LIGHT_AFCS_SAS2")
defineIndicatorLight("AFC_TRM_LGHT",	244, "AFCS", "LIGHT_AFCS_TRIM")
defineIndicatorLight("AFC_FPS_LGHT",	245, "AFCS", "LIGHT_AFCS_FPS")
defineIndicatorLight("AFC_STB_LGHT",	246, "AFCS", "LIGHT_AFCS_STABAUTO")
...
--Electric System
defineToggleSwitch(				"BATT_SW",		27, 3013, 17, 		"Electric System", "Battery Switch OFF/ON")
defineSpringloaded_3_pos_tumb(	"EXT_PWR_SW",  	27, 3014, 3021, 18, "Electric System", "External Power Switch RESET/OFF/ON")
defineSpringloaded_3_pos_tumb(	"APU_GEN_SW",  	27, 3015, 3018, 19, "Electric System", "APU GEN Switch TEST/OFF/ON")
defineSpringloaded_3_pos_tumb(	"GEN1_SW",	 	27, 3016, 3019, 20, "Electric System", "GEN 1 Switch TEST/OFF/ON")
defineSpringloaded_3_pos_tumb(	"GEN2_SW",	 	27, 3017, 3020, 21, "Electric System", "GEN 2 Switch TEST/OFF/ON")

--Fuel and Engines
defineSpringloaded_3_pos_tumb("FUEL_PMP_SW", 27, 3022, 3022, 22, "Fuel and Engines", "FUEL PRIME/OFF/APU BOOST")
defineSpringloaded_3_pos_tumb("AIR_SRC_SW",  27, 3023, 3023, 23, "Fuel and Engines", "Air Source APU/OFF/ENG" )
defineToggleSwitch("APU_CTRL_SW",			 27, 3024, 24, "Fuel and Engines", "APU CONTROL OFF/ON")
defineToggleSwitch("FUEL1_BST_PMP",			 27, 3044, 40, "Fuel and Engines", "Boost Pump 1 OFF/ON")

-- APU EXTINGUISH
definePotentiometer("ENG1_CTRL",	  16, 3206, 26, {0,1}, 					 "APU Extinguish", "Engine 1 Control")
definePotentiometer("ENG2_CTRL",	  16, 3207, 27, {0,1}, 					 "APU Extinguish", "Engine 2 Control")

defineMultipositionSwitch("ENG1_FSS", 16, 3208, 28, 3, 0.5, 				 "APU Extinguish", "Engine 1 FSS OFF/DIR/XFD") --3, 1/2, false, 0, 1, false)
defineMultipositionSwitch("ENG2_FSS", 16, 3209, 29, 3, 0.5, 				 "APU Extinguish", "Engine 2 FSS OFF/DIR/XFD") --3, 1/2, false, 0, 1, false)
defineToggleSwitch("ENG1_START",	  16, 3210, 30, 						 "APU Extinguish", "Engine 1 Starter")
defineToggleSwitch("ENG2_START",	  16, 3211, 31, 						 "APU Extinguish", "Engine 2 Starter")
defineTumb("ENG1_CTR_LVL",			  16, 3204, 42,  1, {-1, 0}, nil, false, "ECQ", "Engine 1 Control Level OFF/IDLE")
defineTumb("ENG2_CTR_LVL",			  16, 3205, 43,  1, {-1, 0}, nil, false, "ECQ", "Engine 2 Control Level OFF/IDLE")


-- STAB PANEL
defineSpringloaded_3_pos_tumb(	"STAB_MAN_SLW", 17, 3228, 3229, 32, "STAB Panel", "Manual Slew UP")
definePushButton(				"STAB_AUTO",	17, 3222, 33, 		"STAB Panel", "STAB OFF/ON")
definePushButton(				"SAS1",			17, 3223, 34, 		"STAB Panel", "SAS 1 OFF/ON")
definePushButton(				"SAS2",			17, 3224, 35, 		"STAB Panel", "SAS 2 OFF/ON")
definePushButton(				"TRIM",			17, 3225, 36,		"STAB Panel", "Trim OFF/ON")
definePushButton(				"FPS",			17, 3226, 37,		"STAB Panel", "FPS OFF/ON")
definePushButton(				"SAS_BST",		17, 3227, 38,		"STAB Panel", "SAS Boost OFF/ON")
--definePushButton("AUTO_TRIM1",52, 3452, 39, "STAB Panel", "Auto Trim ON/OFF")

-- -- PARKING BRAKE
defineToggleSwitch("PRK_BRK",	27, 3402, 80, "General", "Parking Brake")
...
-- -- MISC
defineToggleSwitch("TAIL_WHL_LCK",	46, 3410, 291, "Misc", "Tail Wheel LOCK/UNLOCK")

-- -- CAUTION/DISPLAY PANELS
definePushButton("CDU_TST",			25, 3230, 301, "Vids", "CDU Lamp Test")
definePushButton("PDU1_TST",		25, 3231, 302, "Vids", "PDU Test Pilot")
...
-- -- AN/ASN-128B
defineMultipositionSwitch("128B_DISPLAY", 23, 3236,	500, 7, 0.01, "AN/ASN-128B", "AN/ASN-128B Select Display")
defineMultipositionSwitch("128B_MODE",    23, 3235,	501, 6, 0.01, "AN/ASN-128B", "AN/ASN-128B Select Mode")
definePushButton("128B_KYBD",			23, 3237, 502, "AN/ASN-128B", "AN/ASN-128B Select Button KYBD")
definePushButton("128B_LTR_LFT",		23, 3238, 503, "AN/ASN-128B", "AN/ASN-128B Select Button LTR Left")
definePushButton("128B_LTR_MID",		23, 3239, 504, "AN/ASN-128B", "AN/ASN-128B Select Button LTR Mid")
definePushButton("128B_LTR_RGHT",		23, 3240, 505, "AN/ASN-128B", "AN/ASN-128B Select Button LTR Right")
definePushButton("128B_F1",				23, 3241, 506, "AN/ASN-128B", "AN/ASN-128B Select Button F1")
definePushButton("128B_1",				23, 3242, 507, "AN/ASN-128B", "AN/ASN-128B Select Button 1")
definePushButton("128B_2",				23, 3243, 508, "AN/ASN-128B", "AN/ASN-128B Select Button 2")
definePushButton("128B_3",				23, 3244, 509, "AN/ASN-128B", "AN/ASN-128B Select Button 3")
definePushButton("128B_TGT_STR",		23, 3245, 510, "AN/ASN-128B", "AN/ASN-128B Select Button TGT STR")
definePushButton("128B_4",				23, 3246, 511, "AN/ASN-128B", "AN/ASN-128B Select Button 4")
definePushButton("128B_5",				23, 3247, 512, "AN/ASN-128B", "AN/ASN-128B Select Button 5")
definePushButton("128B_6",				23, 3248, 513, "AN/ASN-128B", "AN/ASN-128B Select Button 6")
definePushButton("128B_INC",			23, 3249, 514, "AN/ASN-128B", "AN/ASN-128B Select Button INC")
definePushButton("128B_7",				23, 3250, 515, "AN/ASN-128B", "AN/ASN-128B Select Button 7")
definePushButton("128B_8",				23, 3251, 516, "AN/ASN-128B", "AN/ASN-128B Select Button 8")
definePushButton("128B_9",				23, 3252, 517, "AN/ASN-128B", "AN/ASN-128B Select Button 9")
definePushButton("128B_DEC",			23, 3253, 518, "AN/ASN-128B", "AN/ASN-128B Select Button DEC")
definePushButton("128B_CLR",			23, 3254, 519, "AN/ASN-128B", "AN/ASN-128B Select Button CLR")
definePushButton("128B_0",				23, 3255, 520, "AN/ASN-128B", "AN/ASN-128B Select Button 0")
definePushButton("128B_ENT",			23, 3256, 521, "AN/ASN-128B", "AN/ASN-128B Select Button ENT")

-- -- CISP
definePushButton("CIS_HDG", 39, 3369, 930, "CISP", "CISP Pilot HDG OFF/ON")
definePushButton("CIS_NAV", 39, 3370, 931, "CISP", "CISP Pilot NAV OFF/ON")
definePushButton("CIS_ALT", 39, 3371, 932, "CISP", "CISP Pilot ALT OFF/ON")

definePushButton("NAV_DPLR", 37, 3372, 933, "CISP", "CISP Pilot DLPR GPS OFF/ON")
definePushButton("NAV_VOR",  37, 3373, 934, "CISP", "CISP Pilot VOR ILS OFF/ON")
definePushButton("NAV_BACK", 37, 3374, 935, "CISP", "CISP Pilot BACK CRS OFF/ON")
definePushButton("NAV_FM",   37, 3375, 936, "CISP", "CISP Pilot FM HOME OFF/ON")
definePushButton("TRN_RATE", 37, 3376, 937, "CISP", "CISP Pilot TURN RATE NORM/ALTR")
definePushButton("CRS_HDG",  37, 3377, 938, "CISP", "CISP Pilot CRS HDG - PLT/CPLT")
definePushButton("VRT_GYRO", 37, 3378, 939, "CISP", "CISP Pilot VERT GYRO NORM/ALTR")
definePushButton("BRG2",     37, 3379, 940, "CISP", "CISP Pilot BRG2 ADF/VOR")

-- -- AN/AVS-7 PANEL
defineTumb(					  "AVS_ON",  30, 3257, 1100, 1, {-1, 1}, nil, false, "AN/AVS-7 HUD", "AN/AVS-7 OFF/ON/ADJ")
defineSpringloaded_3_pos_tumb("AVS_DIM", 30, 3259, 3258, 1106, 				     "AN/AVS-7 HUD", "AN/AVS-7 DIM/BRIGHT")
...
-- -- Lighting
definePotentiometer(			"GLR_SHLD", 	 20, 3272, 251, {0,1}, 					"Lights", "Glareshield Lights OFF/BRT")
defineSpringloaded_3_pos_tumb(	"POS_LGHT_DIM",  20, 3281, 3281, 252, 					"Lights", "Position Lights DIM/OFF/BRT")
defineTumb(						"POS_LGTH_MOD",  20, 3282, 253,  1, {0, 1}, nil, false, "Lights", "Position Lights STEADY/FLASH")
defineSpringloaded_3_pos_tumb(	"ANTI_LGHT_UP",	 20, 3283, 3283, 254, 					"Lights", "Anticollision Lights UPPER/BOTH/LOWER")
defineSpringloaded_3_pos_tumb(	"ANTI_LGHT_DAY", 20, 3284, 3284, 255, 					"Lights", "Anticollision Lights DAY/OFF/NIGHT")
defineTumb(						"NAV_LGTH_MOD",  20, 3285, 256,  1, {0, 1}, nil, false, "Lights", "Nav Lights NORM/IR")
defineSpringloaded_3_pos_tumb(	"POS_LGHT", 	 20, 3286, 3286, 257, 					"Lights", "Cabin Lights BLUE/OFF/WHITE")
definePotentiometer(			"LGHT_SWTCH",    20, 3274, 260, {0,1},       			"Lights", "Lighted Switches OFF/BRT")
defineMultipositionSwitch(		"FORM_LGHT", 	 20, 3275, 261,  6, 0.2,	    		"Lights", "Formation Lights OFF/1/2/3/4/5")

definePotentiometer("UPP_BRT",			20, 3276, 262, {0,1}, "Lights", "Upper Console Lights OFF/BRT")
definePotentiometer("LWR_BRT",			20, 3277, 263, {0,1}, "Lights", "Lower Console Lights OFF/BRT")
definePotentiometer("PLT_INST_BRT",		20, 3278, 264, {0,1}, "Lights", "Pilot Flight Instrument Lights OFF/BRT")
definePotentiometer("CPLT_INST_BRT",	20, 3273, 259, {0,1}, "Lights", "CoPilot Flight Instrument Lights OFF/BRT")
definePotentiometer("LGHT_BRT",			20, 3279, 265, {0,1}, "Lights", "Non Flight Instrument Lights OFF/BRT")
definePotentiometer("RDR_DIM",			20, 3289, 266, {0,1}, "Lights", "Radar Altimeter DIM")

defineTumb(					  "CMP_LGTH_MOD",  20, 3280, 268,   1, {0, 1}, nil, false,  "Lights", "Magnetic Compass Light OFF/ON")
defineSpringloaded_3_pos_tumb("CKPT_LGHT_DAY", 20, 3287, 3287, 269, 					"Lights", "Cockpit Lights BLUE/OFF/WHITE")
...
--DOORS
defineToggleSwitch("CPLT_DOOR",    46, 3403, 470, "Misc", "Copilot Door OPEN/CLOSE")
defineToggleSwitch("PLT_DOOR",     46, 3404, 471, "Misc", "Pilot Door OPEN/CLOSE")
defineToggleSwitch("LFT_GUN_WIN",  46, 3405, 472, "Misc", "Left Gunner Door OPEN/CLOSE")
defineToggleSwitch("RGT_GUN_WIN",  46, 3406, 473, "Misc", "Right Gunner Door OPEN/CLOSE")
defineToggleSwitch("LFT CRG DOOR", 46, 3407, 474, "Misc", "Left Cargo Door OPEN/CLOSE")
defineToggleSwitch("RGT_CRG_DOOR", 46, 3408, 475, "Misc", "Right Cargo Door OPEN/CLOSE")

-- M130 CM System
defineToggleSwitch("FLR_DSP_CVR", 32, 3308, 550, "M130 CM", "Flare Dispenser Mode Cover OPEN/CLOSE")
defineToggleSwitch("FLR_DSP_SW",  32, 3421, 551, "M130 CM", "Flare Dispenser Switch OFF/ON")
...
defineToggleSwitch(			"CM_ARM_SW", 		32, 3311, 559, 			"M130 CM", "Countermeasures Arming Switch OFF/ON")
defineMultipositionSwitch(	"CHAFF_MOD_SEL", 	32, 3313, 560, 3, 0.5, 	"M130 CM", "Chaff Mode Selector") --3, 1/2, false, 0, 16, false)
definePushButton(			"CHAF_DISP", 		32, 3314, 561, 			"M130 CM", "Chaff Dispense")
...
-- -- WIPERS
defineTumb("WPRS", 46, 3288, 631,  0.5, {-0.5, 1}, nil, false, "Misc", "Wipers PARK/OFF/LOW/HI")
...
defineToggleSwitch("MST_SNR_CVR",			49, 3534, 1998,		  "Aux System Panel", "Master Sonar Cover OPEN/CLOSE")
defineToggleSwitch("MST_ARM_SNR",			49, 3535, 1999,		  "Aux System Panel", "Master Arm Sonar OFF/ON")
defineToggleSwitch("MST_ARM_SON",			49, 3532, 2000,		  "Aux System Panel", "Master Arm Sonobuoys OFF/ON")
defineToggleSwitch("SONO_DISP", 			49, 3533, 2001,		  "Aux System Panel", "Sonobuoy Dispense OFF/ON")
defineSpringloaded_3_pos_tumb("SNR_WNCH", 	49, 3536, 3536, 2002, "Aux System Panel", "Winch Sonar DOWN/STOP/UP")
defineToggleSwitch("MST_SON_CVR",			49, 3531, 2003,       "Aux System Panel", "Master Sonobuoys Cover OPEN/CLOSE")

-- WEAPONS SYSTEM CONTROL PANEL
defineToggleSwitch("MST_ARM_WPN", 		49, 3423, 2004, 		"Weapons System Panel", "Master Arm Weapons OFF/ON")
defineMultipositionSwitch("SLV_SELC",	49, 3424, 2005, 7, 0.1, "Weapons System Panel", "Select SALVE")
defineToggleSwitch("MST_ARM_CVR",		49, 3425, 2006, 		"Weapons System Panel", "Master Arm Cover OPEN/CLOSE")

defineToggleSwitch("STA_LFT_PYL",		49, 3426, 2007, 		"Weapons System Panel", "Stat. Left Pyl. OFF/ON")
defineToggleSwitch("STA_LFT_SID",		49, 3427, 2008, 		"Weapons System Panel", "Stat. Left Side OFF/ON")
defineToggleSwitch("STA_RGT_SID",		49, 3428, 2009, 		"Weapons System Panel", "Stat. Right Side OFF/ON")
defineToggleSwitch("STA_RGT_PYL",		49, 3429, 2010, 		"Weapons System Panel", "Stat. Right Pyl. OFF/ON")

-- -- JETTISON
defineToggleSwitch("JET_SLC_SW",		49, 3437, 2011, 		"Jettison Panel", "Select Jett. Switch OFF/ON")
defineToggleSwitch("JET_SLC_CVR",		49, 3435, 2012, 		"Jettison Panel", "Select Jett. Cover OPEN/CLOSE")
defineToggleSwitch("JET_ALL_CVR",		49, 3434, 2013, 		"Jettison Panel", "All Jett. Cover OPEN/CLOSE")
defineToggleSwitch("JET_ALL",			49, 3436, 2014, 		"Jettison Panel", "All Jett. Switch OFF/ON")
defineMultipositionSwitch("JET_SELC",	49, 3433, 2016, 8, 0.1, "Jettison Panel", "Select STATIONS")

-- -- GUNSIGHT
defineMultipositionSwitch(	"GUN_COLR",	50, 3550, 2025, 3, 0.5, "GunSight", "GunSight COLOR")
definePotentiometer(		"GUN_MOVE",	50, 3551, 2026, {-1,1}, "GunSight", "GunSight Move UP/DOWN")

-- -- RADAR
definePotentiometer(			"RANGE_RDR",	49, 3539, 2023, {-1,1}, 	"Radar", "Range -/+")
definePotentiometer(			"SECT_RDR",		49, 3540, 2020, {-0.8,0.9}, "Radar", "Sector -/+")
defineMultipositionSwitch(		"MODE_RDR",		49, 3541, 2027, 4, 0.33, 	"Radar", "Mode OFF/ON/INT./SOL.")
defineSpringloaded_3_pos_tumb(	"SON_SELC",		49, 3542, 3542, 2028, 		"Radar", "Sonobuoys SURFACE/OFF/IMMERSION")
defineMultipositionSwitch(		"COAL_SELC",	49, 3543, 2029, 4, 0.33, 	"Radar", "Coalition Select ALL/NEUTRAL/FRIENDLY/ENEMY")
defineMultipositionSwitch(		"FAC_RANGE",	49, 3545, 2030, 2, 0.66, 	"Radar", "Range FACTOR")
defineMultipositionSwitch(		"CAT_SELC",		49, 3544, 2031, 2, 0.66, 	"Radar", "Category Select SEA/GROUND")
definePotentiometer(			"OFFSET_RDR",	49, 3546, 2032, {-0.9,0.9}, "Radar", "Rotation Sector <-/->")
defineToggleSwitch(				"LCK_TGT",		49, 3548, 2037, 			"Radar", "Lock Target OFF/ON")
definePushButton(				"RST_ROT",		49, 3547, 2039, 			"Radar", "Rotation Radar RESET")
